...
class TopOffLoads extends React.Component {
    ...
    state = {
        ...
        allFilters: {
            ...
            month:[ { title:'Januar', checkState:false, value:'01'}, 
                    { title:'Februar', checkState:false, value:'02'},
                    { title:'March', checkState:false, value:'03'},
                    { title:'April', checkState:false, value:'04'}, 
                    { title:'May', checkState:false, value:'05'},
                    { title:'July', checkState:false, value:'06'}, 
                    { title:'Juny', checkState:false, value:'07'},
                    { title:'August', checkState:false, value:'08'}, 
                    { title:'September', checkState:false, value:'09'},
                    { title:'Oktomber', checkState:false, value:'10'}, 
                    { title:'November', checkState:false, value:'11'},
                    { title:'December', checkState:false, value:'12'} ],
